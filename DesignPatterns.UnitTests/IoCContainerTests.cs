...
namespace DesignPatterns.UnitTests
{
    public class IoCContainerTests
    {
        ...
        [Fact]
        public void Given_ServiceCollectionAddedSingletonServiceWithFactoryThatUseProviderAndThrowException_When_CallGetService_Then_ExceptionThrown()
        {
            _services.AddSingleton<SomeSingleton>(p => throw new InvalidOperationException());

            IServiceProvider provider = _services.BuildServiceProvider();

            Assert.Throws<InvalidOperationException>(() => provider.GetService<SomeSingleton>());
        }

        [Fact]
        public void Given_ServiceCollectionAddedSingletonServiceWithFactoryThatThrowException_When_CallGetService_Then_ExceptionThrown()
        {
            _services.AddSingleton<SomeSingleton>(() => throw new InvalidOperationException());
        ...
        [Fact]
        public void Given_ServiceCollectionAddedTransientServiceWithFactoryThatThrowException_When_CallGetService_Then_ExceptionThrown()
        {
            _services.AddTransient<SomeTransient>(() => throw new InvalidOperationException());

            IServiceProvider provider = _services.BuildServiceProvider();

            Assert.Throws<InvalidOperationException>(() => provider.GetService<SomeTransient>());
        }

        [Fact]
        public void Given_ServiceCollectionAddedTransientServiceWithFactoryThatUseProviderAndThrowException_When_CallGetService_Then_ExceptionThrown()
        {
            _services.AddTransient<SomeTransient>(p => throw new InvalidOperationException());
